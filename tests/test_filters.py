...
def test_filter_callback_test():
    ...
    assert (
        """helics.HelicsMessageFederate(name = "Testfilter", state = HelicsFederateState.STARTUP, current_time = -9223372036.854776, n_publications = 0, n_inputs = 0, n_endpoints = 0, n_filters = 1, n_pending_messages = 0)"""
        in repr(fFed)
    )
    assert (
        """helics.HelicsMessageFederate(name = "Testmessage", state = HelicsFederateState.STARTUP, current_time = -9223372036.854776, n_publications = 0, n_inputs = 0, n_endpoints = 2, n_filters = 1, n_pending_messages = 0)"""
        in repr(mFed)
    )
    ...
    assert (
        """helics.HelicsMessageFederate(name = "Testfilter", state = HelicsFederateState.EXECUTION, current_time = 0.0, n_publications = 0, n_inputs = 0, n_endpoints = 0, n_filters = 1, n_pending_messages = 0)"""
        in repr(fFed)
    )
    assert (
        """helics.HelicsMessageFederate(name = "Testmessage", state = HelicsFederateState.EXECUTION, current_time = 0.0, n_publications = 0, n_inputs = 0, n_endpoints = 2, n_filters = 1, n_pending_messages = 0)"""
        in repr(mFed)
    )
